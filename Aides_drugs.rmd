...
### Graphical Results
```{r}
barchartGC(~infected + group, data=Scarolina, type="percent", main = "South Carolina Male and Female")
```
...
### Graphical Results
```{r}
barchartGC(~infected + group, data=cenAfrica, type="percent", main = "Central Africa Male and Female")
```
...
### Graphical Results
```{r}
barchartGC(~infected + group, data=korea, type="percent", main = "Central Africa Male and Female")
```
...
barchartGC(~infected + group, data=koreaM, type="percent", main = "Central Africa Male")
```

```{r}
koreaF<-filter(korea,sex=="F")
barchartGC(~infected + group, data=koreaF, type="percent", main = "Central Africa Female")
```
